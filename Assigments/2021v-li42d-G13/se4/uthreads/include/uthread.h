...
typedef enum uthread_priority priot;
...
// Adicionamos um novo parametro prio para indicar a prioridade
uthread_t * ut_create(void (*start_routine)(void *), void * arg, priot prio);
